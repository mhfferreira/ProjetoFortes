object AlunoIncAltForm: TAlunoIncAltForm
  Left = 347
  Top = 203
  BorderIcons = [biSystemMenu]
  BorderStyle = bsDialog
  Caption = 'AlunoIncAltForm'
  ClientHeight = 141
  ClientWidth = 532
  Color = clBtnFace
  ...
  object DadosPanel: TPanel
    ...
    object CPFEdit: TEdit
      ...
      Width = 200
      Height = 21
      Hint = 'CPF do Aluno. Campo Obrigat'#243'rio.'
      MaxLength = 11
      ParentShowHint = False
      ShowHint = True
      TabOrder = 1
  ...
  object BotaoPanel: TPanel
    ...
    object OkButton: TButton
      ...
      Width = 75
      Height = 26
      Hint = 'Grava os dados digitados da tela de Alunos.'
      Caption = '&OK'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
    ...
    object CancelarButton: TButton
      ...
      Width = 75
      Height = 26
      Hint = 'Limpa os dados digitados da tela de Alunos.'
      Caption = '&Cancelar'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
